---
title: "Server Configuration and Software Installation"
---
...
<Note>
  - If your infrastructure **does not have an OOB network**, your hypervisors will **not have internet access**. Follow the **pre-installation steps** below to temporarily configure internet access **before proceeding** with the installation.
...
<Frame>
  <img src="/images/acs-server2-one-liner.png" alt="acs server2 one liner" />
</Frame>
...
<Note>
  ...
  - If your infrastructure **does not have an OOB network**, and **Underlay is still disabled**, you **will NOT be able to ping the VXLAN gateway yet**. Proceed to the **next step** to enable underlay.
</Note>

<Tabs>
  <Tab title="With OOB (Underlay Enabled)">
    **Verify connectivity:**
  ...
  <Tab title="Without OOB (Underlay Disabled)">
...
<Note>
  - If your infrastructure **did not have an OOB network**, and you created a **temporary OOB VNet**, now is the time to **switch from the temporary connection** to **underlay networking**.
</Note>
...
<Frame>
  <img src="/images/acs-topology-link-edit.png" alt="acs topology link edit" width="330px" height="228px" />
</Frame>

<Frame>
  <img src="/images/acs-server2-link-edit.png" alt="acs server2 link edit" />
</Frame>
