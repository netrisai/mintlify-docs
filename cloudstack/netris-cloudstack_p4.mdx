---
title: "Configuring CloudStack for Netris Integration"
---
...
1. Navigate to the CloudStack GUI and log in as an administrator.
2. Go to **Configuration** → **Global Settings**.
3. In the search field, type "netris" to locate the Netris plugin setting.
4. Enable the Netris plugin by toggling the switch to "ON."
5. Save the settings.

<Frame>
  <img src="/images/acs-enable-netris-plugin.png" alt="acs enable netris plugin" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-zone-details.png" alt="acs wizard zone details" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-physical-network.png" alt="acs wizard physical network" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-netris-details.png" alt="acs wizard netris details" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-public-network1.png" alt="acs wizard public network1" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-public-network2.png" alt="acs wizard public network2" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-public-netris-pool.png" alt="acs wizard public netris pool" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-pod1-details.png" alt="acs wizard pod1 details" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-vxlan-range.png" alt="acs wizard vxlan range" />
</Frame>
...
<Frame>
  <img src="/images/acs-wizard-launch-zone.png" alt="acs wizard launch zone" />
</Frame>
...
<Note>
  Users should refer to the [Apache CloudStack Documentation](https://docs.cloudstack.apache.org/) for detailed guidance on these steps if needed.
</Note>
