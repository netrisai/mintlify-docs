---
title: "Using CloudStack with Netris Isolation Method"
---

This chapter outlines how to use the CloudStack platform with the Netris isolation method.

1. Creating and Managing a VPC in CloudStack with Netris Integration
2. Adding Tier Networks
3. Configuring NAT (Network Address Translation)
4. Creating Load Balancers
5. Assigning Public IPs
