...
<Frame>
  <img src="/images/dhcp-option-set.png" alt="DHCP Option Set" />
</Frame>
...
<Frame>
  <img src="/images/dhcp-standard-options.png" alt="Standard DHCP Options" />
</Frame>
...
<Frame>
  <img src="/images/dhcp-custom-options.png" alt="Custom DHCP Options" />
</Frame>
...
<Frame caption="Figure: Netris DHCP configuration in V-Net settings">
  <img src="/images/dhcp-builtin.png" alt="Netris DHCP configuration in V-Net settings" />
</Frame>
...
<Frame>
  <img src="/images/vnet-dhcp-relay.png" alt="DHCP Relay" />
</Frame>
...
<Frame>
  <img src="/images/vnet-dhcp-relay-diagram.png" alt="DHCP Relay" />
</Frame>
...
1. In each tenant's V-Net (VPC-Bravo1 and VPC-Alpha1), enable DHCP Relay and set the DHCP server address to the IPs of the DHCP servers in VPC-Shared-Infra.
   ...
   <Frame>
     <img src="/images/dhcp-relay-coke.png" alt="DHCP Relay" />
   </Frame>

   <br />

   <Frame>
     <img src="/images/dhcp-relay-pepsi.png" alt="DHCP Relay" />
   </Frame>

   <br />

   <Frame>
     <img src="/images/dhcp-relay-shared.png" alt="DHCP Relay" />
   </Frame>
...
2. Establish VPC peering between VPC-Bravo1 ↔ VPC-Shared-Infra and VPC-Alpha1 ↔ VPC-Shared-Infra.
   ...
   <Frame>
     <img src="/images/dhcp-relay-vpc-peer-coke.png" alt="DHCP Relay" />
   </Frame>

   <br />

   <Frame>
     <img src="/images/dhcp-relay-vpc-peer-pepsi.png" alt="DHCP Relay" />
   </Frame>
