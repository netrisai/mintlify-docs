...
- FEC - Toggle FEC mode. Available only for physical ports.
  ...
  | Platform | Supported Modes | Default |
  | --- | --- | --- |
  | Spectrum-X (Cumulus) | Auto, Base-R, RS, Off | Auto |
  | Arista | Auto, Base-R, RS, Off | Auto |
  | SONiC | Auto, Base-R, RS, Off | Off |
...
<Frame>
  <img src="/images/edit-port.png" alt="edit port" />
</Frame>
...
Edit - Edit the port. Admin UP/Down - Toggle the port's admin status.

Add to LAG - Add selected ports into a LAG.

<Frame>
  <img src="/images/add-to-lag-port.png" alt="add to lag port" />
</Frame>
