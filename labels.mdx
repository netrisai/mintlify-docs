...
Labels (sometimes called tags) can be used to automatically place hundreds of switch ports into a V-Net. They can work together with the [Server Cluster](/server-cluster) and manual methods, or they can replace those methods.
...
<Frame caption="Figure: Server interface labels">
  <img src="/images/server-interface-labels.png" alt="Server interface labels" />
</Frame>
...
<Frame caption="Figure: Add Network Interface Label dialog">
  <img src="/images/add-vnet-interface-based-on-label.png" alt="Add Network Interface Label dialog" />
</Frame>
...
Labels can be used on their own or together with [Server Cluster](/server-cluster).
...
<Frame caption="Figure: GPU Cluster Template">
  <img src="/images/GPU-cluster-template.png" alt="GPU Cluster Template" />
</Frame>

- Label the IPMI (*eth11*) NIC rather than include it in the Server Cluster Template.

<Frame caption="Figure: The operator adds a iface.eth11=ipmi label to each server object for eth11">
  <img src="/images/label-eth11-ipmi.png" alt="The operator adds a iface.eth11=ipmi label to each server object for eth11" />
</Frame>

- Create a V-Net that includes this label as described earlier.

<Frame caption="Figure: The operator creates a V-Net for the management interfaces and adds network interfaces matching the ipmi label value.">
  <img src="/images/create-vnet-label-ipmi.png" alt="The operator creates a V-Net for the management interfaces and adds network interfaces matching the ipmi label value." />
</Frame>
...
- Create new *East-West* and *North-South-in-band-and-storage* V-Nets in the VPCs selected when defining the Server Cluster. See [Server Cluster](/server-cluster) for more details about creating Server Clusters.
