---
title: "Link Aggregation and Multihoming"
---
...
<Frame>
  <img src="/images/lag_diagram.png" alt="LAG diagram" />
</Frame>
...
<Frame>
  <img src="/images/inventory-profile-automatic-link-aggregation.png" alt="Inventory Profile with Automatic Link Aggregation enabled" />
</Frame>
...
<Frame>
  <img src="/images/server-custom-json.png" alt="Server Object with custom JSON defining a bond interface" />
</Frame>

<br />

```json Example JSON snippet defining a bond interface
{
    "network": {
        "eth9": {
            "slave": "bond0",
...
<Frame>
  <img src="/images/inventory-profile-set-enable-MCLAG.png" alt="Inventory Profile with Enable MC-LAG checkbox set" />
</Frame>
...
<Frame>
  <img src="/images/create-mclag-peer-link.png" alt="Create Link dialog with MC-LAG Peer Link checkbox set" />
</Frame>
...
<Frame>
  <img src="/images/interfaces-bulk-action-add-to-lag.png" alt="Bulk action menu with Add to LAG option" />
</Frame>
...
<Frame>
  <img src="/images/add-to-LAG.png" alt="Add to LAG dialog" />
</Frame>
...
<Frame>
  <img src="/images/interfaces-list-agg-interface.png" alt="List of network interfaces with aggregation interface" />
</Frame>
