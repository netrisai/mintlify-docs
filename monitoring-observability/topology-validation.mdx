---
title: "Topology & Wiring Validation"
---
...
<Frame caption="Figure: Two cables between the leaf and the spine switches are miswired">
  <img src="/images/switch-to-switch-cables-swapped.png" alt="Two cables between the leaf and the spine switches are miswired" />
</Frame>
...
<Frame caption="Figure: Two cables between two leaf switches and server NICs are miswired">
  <img src="/images/switch-to-server-cables-swapped.png" alt="Two cables between two leaf switches and server NICs are miswired" />
</Frame>
