...
<Warning>
  Starting with Netris 4.9 release, the Netris Host Networking Plugin supports only Spectrum-X Reference Architecture version 2.1.2. Support for earlier Spectrum-X Reference Architectures has been deprecated. See [Netris 4.9 Release Notes](/release-notes#april-30-2026) for details. You may find earlier version of this document in the Netris 4.8 documentation: [Netris Host Networking Plugin](https://www.netris.io/docs/en/4.8/ai-netris-host-networking.html).
</Warning>
...
<Note>
  The above NVIDIA packages must be obtained from [Nvidia directly](https://developer.nvidia.com/doca-downloads?deployment_platform=Host-Server&deployment_package=DOCA-Host&target_os=Linux&Architecture=x86_64&Profile=doca-all&Distribution=Ubuntu&version=24.04&installer_type=deb_local) and are not distributed by Netris.
</Note>
...
| Component | GPU Platform H100 | H200 | B200 | GB200 | B300 | GB300 |
| --- | --- | --- | --- | --- | --- | --- |
