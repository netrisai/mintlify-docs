...
<Frame>
  <img src="/images/ZTP-process-diagram.svg" alt="ZTP process diagram" />
</Frame>
...
See: [Deploy North-South controller VIP](/installation/controller-k3s-air-gap-ha#9-deploy-north-south-controller-vip-optional)
...
See: [Installing the Local Repository](/installation/controller-k3s-air-gap-ha#13-set-up-the-local-netris-repository)

### 3. Upload NOS images to the local repo

Identify the path to the local directory where the local repo is located on each of the controller nodes (`$PVC_PATH`), as described in the [Local Repo installation instructions](/installation/controller-k3s-air-gap-ha#13-set-up-the-local-netris-repository).
...
By default, the Netris agent installer is downloaded from the Netris public repository. You can optionally enable the [Local Repository feature](/installation/controller-k3s-air-gap-ha#13-set-up-the-local-netris-repository) for the Netris agent installer to be sourced directly from the Netris controller.
...
<Frame>
  <img src="/images/ZTP-ControllerManagementAddress.png" alt="ZTP ControllerManagementAddress" />
</Frame>
...
<Frame>
  <img src="/images/ZTP-IPAM.png" alt="ZTP IPAM" />
</Frame>
...
<Info>
  ...
  <Frame>
    <img src="/images/ztp-ipam-management-default-gateway.png" alt="ztp ipam management default gateway" />
  </Frame>
</Info>
...
<Frame>
  <img src="/images/ZTP-Vnet-Relay.png" alt="ZTP Vnet Relay" />
</Frame>
...
<Frame>
  <img src="/images/ZTP-Inventory-Profile.png" alt="ZTP Inventory Profile" />
</Frame>
...
<Frame>
  <img src="/images/ZTP-MAC-address.png" alt="ZTP MAC address" />
</Frame>
...
3. Configure Static Routes on the Controller Nodes
...
<Frame>
  <img src="/images/ZTP-health.png" alt="ZTP health" />
</Frame>
